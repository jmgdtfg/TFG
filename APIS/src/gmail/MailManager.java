...
public class MailManager {
	 ...
	 * 		servidor de hotmail
	 */		
	public MailManager(String usuario,String password, String servidor){
	...
	private void build(String servidor){
		...
		this.session_ = Session.getInstance(props_,
			...
			protected PasswordAuthentication getPasswordAuthentication(){
				return new PasswordAuthentication(usuario_,password_);
			}
		});
		...
		try{
			...
			//connect(server,user,pass)
				...
				store.connect(fc.getServer(servidor), this.usuario_, this.password_);
